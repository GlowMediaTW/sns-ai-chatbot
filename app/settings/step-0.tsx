...
import { clientModelRecord, freeClientModelRecord, paidClientModelRecord } from '@/libs/client';
    ...
    return (
      <>
        ...
        <div className="col-12 d-flex align-items-center flex-wrap">
          {Object.entries(freeClientModelRecord).map(([modelType, clientModel]) => (
            <div
              key={modelType}
        ...
        <div className="col-12 d-flex align-items-center">
          {Object.entries(paidClientModelRecord).map(([modelType, clientModel]) => (
            <div
              key={modelType}
              className="col-lg-4 col-12"
              style={{ height: '64px', padding: '2px' }}
