import { appSchema, connectionSchema, discordRegisterCommandsSchema } from '@/libs/schemas';
...
export default class DiscordClientApp implements BaseClientApp<'discord'> {
  public readonly type = 'discord';
  public readonly label = 'Discord';
  public readonly icon = '/images/apps/discord/icon.png';
  ...
  public getForm(_config: z.infer<typeof appSchema>) {
    const config = _config as Extract<z.infer<typeof schema>, { type: 'discord' }>;
    return (
      <>
        <Form.Item
  ...
  public getTutorial() {
    return (
      <Markdown
        content={`1. Sign in at [Discord Developer Portal](https://manager.line.biz/account/).
2. Click here to create a new application.

![](/images/apps/discord/tutorial_1.png)
...
![](/images/apps/discord/tutorial_2.png)`}
      />
    );
  }
  ...
  public getPostTutorial(
    ...
    const config = connection.app as Extract<z.infer<typeof schema>, { type: 'discord' }>;
    return (
      <>
        ...
        <div className="my-2">
          ...
          <img
            src="/images/apps/discord/tutorial_3.png"
            alt="discord_3"
            style={{
              maxWidth: '100%',
              maxHeight: '16rem',
        ...
        <Form<{ botToken: string }>
          className="mb-3"
          layout="vertical"
          onFinish={async ({ botToken }) => {
            try {
              const payload: z.infer<typeof discordRegisterCommandsSchema> = {
                botToken,
              };
              await fetch(`/api/connections/${connection.id}/discord/register-commands`, {
                method: 'POST',
                headers: {
        ...
        <div className="my-2">
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img
            src="/images/apps/discord/tutorial_5.png"
            alt="discord_5"
            style={{
              maxWidth: '100%',
              maxHeight: '16rem',
